...
WITH created AS (
  SELECT
    ...
    COALESCE(NULLIF(payload, '')::jsonb ->> 'snapshot', snapshot_ledger, '0')::bigint AS snapshot_ledger,
    COALESCE(NULLIF(payload, '')::jsonb ->> 'vote_start', vote_start_timestamp, '0')::bigint AS vote_start_timestamp,
